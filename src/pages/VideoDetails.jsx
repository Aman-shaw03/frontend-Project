...
function VideoDetail() {
    ...
    function handleCreateNewPlaylist(eventObj) {
        ...
        dispatch(createPlaylist({ data: { name } })).then((res) => {
            ...
            } // if we create a playlist then automatically upload the video in that playlist
        });
    }
                            ...
                            <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
                                <div className="flex items-center justify-between gap-x-4 md:justify-end lg:justify-between xl:justify-end">
                                    ...
                                    <div className="relative block">
                                        ...
                                        <button
                                            onClick={handleSavePlaylist} // get the playlist , jisme yeh video hai 
                                                    ...
                                                    playlists?.map((item) => (
                                                        <li key={item._id} className="mb-2 last:mb-0">
                                                            ...
                                                            >
                                                                ...
                                                                } // if ticked = video will add to the playlist
                                                                />

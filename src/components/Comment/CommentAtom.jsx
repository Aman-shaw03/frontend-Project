...
import {updateComment, getVideoComments, deleteComment } from "../../app/Slices/commentSlice"
...
function CommentAtom({
    ...
    function handleDelete(){
        ...
        .then(()=> dispatch(getVideoComments(videoId)))
    }
            ...
            <div className="block w-full">
              ...
              <p className="my-1 text-[14px]">
                <input
                  ...
                  disabled={!isEditing || !comment.isOwner}

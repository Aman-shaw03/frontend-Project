...
import {toggleCommentLike, toggleLike} from "../../app/Slices/likeSlice"


// so make a like button and dislike button 
// togglecomment like accepts a commentid and toggleLike
//dispatch it and keep the same in a state (like, dislike)
function CommentLike({
    ...
    const toggleLike = (toggleLike)=>{
        dispatch(toggleCommentLike({commentId, toggleLike}))
        .then(
            (res)=>{
                if(res.payload){
                    let {isLiked,isDisliked, totalDislikes, totalLikes} = res.payload
                }

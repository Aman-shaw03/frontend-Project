...
function AboutChannel({ owner = false }) {
    const dispatch = useDispatch();
    let { username } = useParams(); // we will take userName from url
    let aboutChannel = useSelector(({ user }) => user.userData?.about);
    ...
    // if we dont get aboutChannel , render a loading screen
    if (!aboutChannel) {
        return (

...
// In here we will create a subscribe button and a Edit button and the username and fullName , the number of subscribers and and no of channel we have subscribe too and avatar 
...
function ChannelProfileAtom({profile, owner=false}) {
    ...
    return (
        <div className="flex flex-wrap gap-4 pb-2 pt-2 sm:pb-4 sm:pt-6"> // here we are passing the ref to control/call methods on loginPopup
            ...
            {owner ? (
                <button // if he is the owner , navigate to settings
                ...
                <button // else let him subscribe /unsubscribe
                onClick={handleClick}
                className={`${

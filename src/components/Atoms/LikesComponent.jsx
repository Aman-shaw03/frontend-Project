...
function LikesComponent(
    ...
    const handleToggleLike = (status)=>{
        // status here we passed from the like and dislike button
        ...
        if(status){
            // here we got two types of status (true from like) and (false from dislike)
            // think like - there will be situation 1. there is no like, 2. there is already like , 3. there is dislike
        ...
        else if(commentId) qs = `commentId=${videoId}`
        else if(tweetId) qs = `tweetId=${videoId}`
